...
var Documentation = class _Documentation {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Documentation, selectors: [["app-documentation"]], decls: 68, vars: 0, consts: [[1, "card"], [1, "font-semibold", "text-2xl", "mb-4"], [1, "font-semibold", "text-xl", "mb-4"], [1, "text-lg", "mb-4"], [1, "app-code"], [1, "bg-highlight", "px-2", "py-1", "rounded-border", "not-italic", "text-base"], [1, "leading-normal", "list-disc", "pl-8", "text-lg", "mb-4"], [1, "text-primary", "font-medium"]], template: function Documentation_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "Sakai is an application template for Angular and is distributed as a CLI project. Current versions is Angular v20 with PrimeNG v20. In case CLI is not installed already, use the command below to set it up.");
      \u0275\u0275domElementEnd();
...
ng serve</code></pre>
    ...
    `, styles: ["/* angular:styles/component:scss;8e3f0b030d88dc23a8b89f67cf25473a98b55e2c985009a8d6c99cd68a094bfd;C:/Users/hered/codes/cafecitos-ng/src/app/pages/documentation/documentation.ts */\n@media screen and (max-width: 991px) {\n  .video-container {\n    position: relative;\n    width: 100%;\n    height: 0;\n    padding-bottom: 56.25%;\n  }\n  .video-container iframe {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n  }\n}\n/*# sourceMappingURL=documentation.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-2QQGWJ2J.js.map
